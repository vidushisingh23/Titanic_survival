...
class TitanicVisualizer:
    def __init__(self, data_path="C:\\Users\\Sanjeev Kumar\\Desktop\\Celebal'25\\train3data.csv", output_dir="C:\\Users\\Sanjeev Kumar\\Desktop\\Titanic survival\\outputs"):
    ...
    def ensure_output_dir(self):
        print(f"Please ensure the output directory exists: {self.output_dir}")
